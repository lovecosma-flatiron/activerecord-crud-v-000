...
def can_update_multiple_items_at_once
  ...
  5.times do |i|
    movie = Movie.find_by(title: "Movie_#{i}", release_date: 2000+i)
    movie.title = "A Movie"
    movie.save
  end
end
...
def can_destroy_a_single_item
  ...
  Movie.find_by_title("That One Where the Guy Kicks Another Guy Once").delete
end
